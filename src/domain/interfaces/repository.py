...
class UserRepository(Protocol):
    ...
    def find_by_role(self, role: Role) -> User: ...
...
class ContratRepository(Protocol):
    ...
    def find_by_commercial_contact(self, user_id: int) -> List[Contrat]: ...
...
class EventRepository(Protocol):
    ...
    def find_by_contrat(self, contrat_id: int) -> List[Event]: ...

    def find_by_support_contact(self, user_id: int) -> List[Event]: ...
